...
(function ($) {
	...
	function rotate() {
		var lastChild = $('.slider_carousal div:last-child').clone();
		/*$('#test').html(lastChild)*/
		$('.slider_carousal div').removeClass('firstSlide')
		$('.slider_carousal div:last-child').remove();
		$('.slider_carousal').prepend(lastChild)
